...
function trivial_proto.dissector(buffer,pinfo,tree)
    ...
    local subtree = tree:add(trivial_proto,buffer(),"Ableton Link Data")
    ...
    subtree:add(buffer(24,4),"Timeline framerate: " .. buffer(24,4):uint())
    subtree:add(buffer(28,8),"Timeline BPM multiple: " .. buffer(28,8):uint64())
    subtree:add(buffer(36,8),"Timeline elapsed microbeats: " .. buffer(36,8):uint64())
